...
class UserDataHydrator
{
    public function hydrateRow(array $data): UserData
    {
        ...
        $role = TypeConverter::hydrateValue($data[UserTable::ROLE], UserTable::USER_FIELDS[UserTable::ROLE]);
        ...
        return new UserData($userId, $email, $role, $firstName, $middleName, $lastName, $phone, $avatarUrl, $birthday, $lastVisit);
    }
}